...
export default function DashboardAddonsList() {
  ...
  const [addonMode, setAddonMode] = useState<"create" | "view" | "edit">("create");
  ...
  if (isCreating) {
    return (
      <main className="flex-1 min-w-0 flex flex-col h-full overflow-hidden bg-[#FCF8F8] md: select-none font-poppins relative">
        ...
        <DashboardHeader 
          title="Add-ons" 
          subtitle={addonMode === "create" ? "Create add-ons" : addonMode === "edit" ? "Edit add-on details" : "View add-on details"} 
        />
          ...
          <div className="flex flex-row items-center gap-3 mb-[40px] select-none w-full">
            ...
            <div className="flex flex-row items-center gap-2 text-[13px] font-medium text-[#888780]">
              ...
              <span className="text-[#1C1C1A] font-semibold">
                {addonMode === "create" ? "Create Add-ons" : addonMode === "edit" ? "Edit Add-on" : "View Add-on"}
              </span>
            </div>
          </div>
          ...
          <div className="pl-0 md:pl-[110px] w-full box-sizing-border-box">
            <div className="flex justify-between items-center bg-[#F5F4EE] border border-[#C6C19F] rounded-[12px] p-5 w-full gap-6 mb-8">
              ...
              <button
                ...
                disabled={addonMode === "view"}
                className={`w-[38px] h-[21px] rounded-[11px] p-0.5 transition-colors duration-200 focus:outline-none flex items-center ${addonActive ? "bg-[#0F6E56]" : "bg-neutral-300"} ${addonMode === "view" ? "cursor-not-allowed opacity-80" : "cursor-pointer"}`}
              >
          ...
          <div className="pl-0 md:pl-[110px] w-full box-sizing-border-box flex flex-col gap-[32px]">
            ...
            <div className="flex flex-col gap-2 w-full">
              ...
              <input
                ...
                className={`h-[41px] border border-[#111111]/20 rounded-[12px] px-3 font-poppins text-sm text-[#111111] placeholder:text-[#757575] focus:outline-none w-full ${addonMode === "view" ? "bg-neutral-100 cursor-not-allowed" : "bg-white"}`}
              />
            </div>
              ...
              <div className="flex-1 flex flex-col gap-2">
                ...
                <div className="relative w-full">
                  <select
                    ...
                    className={`appearance-none h-[41px] border border-[#111111]/20 rounded-[12px] px-3 font-poppins text-sm text-[#111111] focus:outline-none w-full pr-[40px] ${addonMode === "view" ? "bg-neutral-100 cursor-not-allowed" : "bg-white cursor-pointer"}`}
                    style={{
                  ...
                  return (
                    <div
                      ...
                      className={`box-sizing-border-box flex items-center justify-between p-3 h-[45px] transition-all rounded-[12px] ${
                        addonMode === "view" ? "cursor-not-allowed" : "cursor-pointer"
                      } ${isSelected
