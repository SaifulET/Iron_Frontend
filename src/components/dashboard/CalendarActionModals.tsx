      ...
      >
        <div className="flex flex-col items-center p-0 gap-2 w-[329px]">
          ...
          <h3 className="w-[329px] font-poppins font-medium text-[28px] leading-[36px] text-[#09090B] text-center">
            Are you sure you want to cancel the no-show timer?
          </h3>

          {/* Subtext */}
          <p className="w-[329px] font-poppins font-normal text-[14px] leading-[20px] text-[#525252] text-center">
            This action is irreversible. This will be considered a successful booking.
          </p>
        </div>

        {/* Buttons footer */}
        <div className="flex flex-row justify-end items-center p-0 gap-3 w-[329px] mt-4">
          <button
            type="button"
            onClick={onClose}
