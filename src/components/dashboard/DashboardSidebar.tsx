      ...
      <div className="border-t border-[#757575]/30 bg-[#C0D5D8] flex flex-col shrink-0 relative">
        ...
        {showFooterMenu && (
          <>
            ...
            <div
              ref={footerMenuRef}
              className={`absolute bottom-[72px] left-3 right-3 z-50 bg-[#B8CED1] border border-[#757575]/25 rounded-xl shadow-2xl flex flex-col py-2 px-3 gap-1 animate-fadeIn`}
            >
              <button 
                onClick={() => {
