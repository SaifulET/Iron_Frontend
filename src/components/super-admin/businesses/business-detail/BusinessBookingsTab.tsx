...
export default function BusinessBookingsTab({ businessId }: BusinessBookingsTabProps) {
  ...
  return (
    <div className="flex flex-col gap-6 w-full font-sans text-gray-900">
      ...
      {/* Date Filters & Dropdown Selectors Row (Responsive Grid) */}
      <div className="grid grid-cols-2 sm:flex sm:flex-wrap sm:items-center gap-3 w-full text-xs text-gray-600">
        ...
        {/* Apply Button */}
        <button className="col-span-2 sm:col-span-1 border border-[#111111] rounded-lg px-4 py-1.5 bg-white hover:bg-gray-55 font-semibold text-[#111111] cursor-pointer">
          Apply
        </button>
