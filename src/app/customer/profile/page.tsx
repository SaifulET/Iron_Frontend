...
export default function ProfilePage() {
  ...
  // Flag & country info list (high quality png flag logos)
  const countries = [
    { flag: "https://flagcdn.com/w20/cy.png", emoji: "🇨🇾", code: "+357" },
    { flag: "https://flagcdn.com/w20/us.png", emoji: "🇺🇸", code: "+1" },
    { flag: "https://flagcdn.com/w20/bd.png", emoji: "🇧🇩", code: "+880" },
    { flag: "https://flagcdn.com/w20/gb.png", emoji: "🇬🇧", code: "+44" },
    { flag: "https://flagcdn.com/w20/de.png", emoji: "🇩🇪", code: "+49" },
    { flag: "https://flagcdn.com/w20/gr.png", emoji: "🇬🇷", code: "+30" },
  ];
  ...
  const getFlagUrl = (code: string) => {
    return countries.find(c => c.code === code)?.flag || "https://flagcdn.com/w20/cy.png";
  };
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-6 w-full max-w-[682px]">
                    ...
                    <div className="flex flex-col items-start gap-1">
                      ...
                      <span className="font-manrope font-medium text-[18px] leading-7 text-[#1C1B1C] flex items-center gap-1.5">
                        <img 
                          src={getFlagUrl(profileData.countryCode)} 
                          alt="Flag" 
                    ...
                    <div className="flex flex-col gap-1 w-full">
                      ...
                      <div className="flex w-full h-11 border border-[#C6C6CB] rounded-lg">
                        ...
                        >
                          ...
                          {showCountryDropdown && (
                            <div className="absolute left-0 top-full mt-1.5 w-[130px] bg-white border border-[#C6C6CB] rounded-lg shadow-lg z-50 py-1 flex flex-col max-h-[220px] overflow-y-auto">
                              {countries.map((c, i) => (
                                <button
                                  key={i}
                                  type="button"
                                  ...
                                  className="flex items-center gap-3 px-3 py-2 hover:bg-neutral-50 text-left w-full transition-colors cursor-pointer"
                                >
                                  <img 
                                    src={c.flag} 
                                    alt={c.code} 
                                    className="w-4 h-3 object-cover shrink-0" 
                                  />
                                  <span className="font-manrope font-semibold text-sm text-[#1C1B1C]">{c.code}</span>
                                </button>
                              ))}
                            </div>
                          )}
