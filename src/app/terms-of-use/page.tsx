...
const useSections: LegalSection[] = [
  {
    id: "introduction",
  ...
  },
  {
    ...
    paragraphs: [
      "In addition to other prohibitions as set forth in the Terms of Service, you are prohibited from using the site or its content: to solicit others to perform or participate in any unlawful acts, to violate any regulations, or to infringe upon our intellectual property rights."
    ],
  },
  {
    id: "termination",
